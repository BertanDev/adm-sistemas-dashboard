...
export function ProfitGroupProducts() {
    const [productGroups, setProductGroups] = useState<Array<{value: number, label: string}>>([])
    const [currentGroup, setCurrentGroup] = useState(0)
    const [initialDate, setInitialDate] = useState<Dayjs>(dayjs().subtract(30, 'day'))
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-4">
        ...
        <Select placeholder="Todos os grupos" options={productGroups} value={currentGroup} onChange={toggleGroup}  />
      </div>
