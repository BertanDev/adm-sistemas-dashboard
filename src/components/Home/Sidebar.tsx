...
import { Home, LucideIcon, CoinsIcon, BadgeCent, PackageSearch, Users } from 'lucide-react'
...
const LinkComponent = ({ href, childrenText, icon: Icon }: LinkComponentProps) => {
  return (
    <li className="mb-4">
      <Link href={href} className="flex items-center gap-4 px-4 py-2 rounded hover:bg-blue-400">
        <Icon size={20} />
